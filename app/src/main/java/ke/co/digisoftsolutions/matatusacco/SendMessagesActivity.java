...
public class SendMessagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddNewCategory = (Button) findViewById(R.id.buttonSendMessage);
            ...
            public void onClick(View v)
            {
                switch (v.getId())
                {
                    case R.id.buttonSendMessage:
                        ...
                        {
                            idno = editTextIdno.getText()
                                    .toString();
                            comments = editTextComments.getText()
                                    .toString();
                            txtContactText = txtContact.getText()
                                    .toString();

                            //
                            CurrentDateText = CurrentDateTxt.getText()
                                    .toString();
                            GetIDText = getDeviceidTxt.getText()
                                    .toString();
                            //
                            //
                            //
                            if (idno.trim()
                                ...
                                Toast.makeText(getApplicationContext(), "Please enter your Id No ", Toast.LENGTH_SHORT)
                                    ...
                                    .length() == 0)
                                Toast.makeText(getApplicationContext(), "Please enter your Comment", Toast.LENGTH_SHORT)
                                        .show();
